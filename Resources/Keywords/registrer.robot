...
Dado que cliente Envie dados validos de registro
    ...
    Crie dados de registro geral super admin    ${criar_email}    ${criar_senha}    ${nome_completo}         
    Set Test Variable    ${criar_email}
    Set Test Variable    ${criar_senha}

Entao confiro se useuario foi cadastrado corretamente 
    Dictionary Should Contain Item    ${resposta.json()}    role    SUPERADMIN
    Dictionary Should Contain Key    ${resposta.json()}     id

Dado que envie para cadastro cliente duplicado na base
        Crie dados de registro geral super admin    ${email_cadastrado}    ${senha_cadastrada}    ${name_user}   
...
E repitir cadastro
    ...
    Crie dados de registro geral super admin    ${email}    ${criar_senha}    ${fullName}
